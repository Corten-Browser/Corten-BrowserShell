# browser_shell Backend Component
...
You are a specialized agent building ONLY the browser_shell backend component.
...
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "browser_shell" "test: Add failing test for POST /users endpoint"
# RED: Test written, currently failing

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "browser_shell" "feat: Implement basic POST /users endpoint"
# GREEN: Minimum code to pass test

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "browser_shell" "test: Add validation tests for user email"
# RED: New test for email validation

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "browser_shell" "feat: Add email validation to user creation"
# GREEN: Email validation implemented

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "browser_shell" "refactor: Extract validation logic to validator module"
# REFACTOR: Code cleanup, tests still pass

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "browser_shell" "test: Add test for duplicate user handling"
# RED: Test for 409 Conflict on duplicate

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "browser_shell" "feat: Return 409 when user already exists"
...
- ✅ Work in your directory: `components/browser_shell/`
...
user_facing_features:
  public_api:
    - class: DataManager
      module: components.browser_shell.src.data_manager
      methods:
        - save_results
        - load_results
        - query_data
    ...
    - function: calculate_benefit
      module: components.browser_shell.src.calculator
      description: Calculate therapeutic benefit scores

    - class: ValidationError
      module: components.browser_shell.src.exceptions
...
**Location**: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/browser_shell-api.yaml`
...
```bash
python orchestration/requirement_annotator.py auto-annotate components/browser_shell
```
...
1. **Verify contract exists:**
   ```bash
   python orchestration/contract_enforcer.py check browser_shell
   ```

2. **If no contract, create one:**
   ```bash
   python orchestration/contract_generator.py generate spec.md browser_shell
   ```

3. **Generate implementation skeleton:**
   ```bash
   python orchestration/contract_enforcer.py skeleton browser_shell
   ```
...
```python
# components/browser_shell/tests/integration/test_api_endpoints.py
...
See API contract: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/browser_shell_api.yaml`
...
- [ ] **Defensive Patterns**: Run `python orchestration/defensive_pattern_checker.py components/browser_shell`
- [ ] **Semantic Correctness**: Run `python orchestration/semantic_verifier.py components/browser_shell`
- [ ] **Contract Compliance**: Run `python orchestration/contract_enforcer.py check browser_shell`
- [ ] **Requirements Traced**: Run `python orchestration/requirements_tracker.py coverage`
- [ ] **Standards Compliance**: Run `python orchestration/consistency_validator.py --component browser_shell`

## Git Commit Procedures

### You work in a SHARED repository

**Location**: Your work is in `components/browser_shell/`
...
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "browser_shell" "feat: Add user authentication"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/browser_shell/

# Commit with component prefix
git commit -m "[browser_shell] feat: Add user authentication"
...
```
[browser_shell] <type>: <description>
...
```bash
git status components/browser_shell/
# or
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_status.py "browser_shell"
```
...
1. **Read the API contract thoroughly**
   ```bash
   cat ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/browser_shell-api.yaml
   ```
...
6. **Commit**
   ...
   python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "browser_shell" "feat: Implement user creation endpoint"
   ```
...
**Check token count**:
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/context_manager.py analyze components/browser_shell
```
...
- ✅ No over-mocking (no `@patch('src.')` or `@patch('components.browser_shell.')`)
...
```bash
# Check test quality
python orchestration/test_quality_checker.py components/browser_shell
...
1. **Over-Mocking Detection**:
   ...
   - ❌ CRITICAL: `@patch('components.browser_shell.validators.EmailValidator')` - Mocking own component
...
```bash
python orchestration/completion_verifier.py components/browser_shell
...
git commit -m "feat(browser_shell): implement user authentication
