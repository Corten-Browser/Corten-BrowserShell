...
You are a specialized agent building ONLY the browser_shell component.
...
- ✅ Work within this directory: `components/browser_shell/`
...
```python
# components/browser_shell/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "browser_shell"}
```
...
```bash
python ../../orchestration/git_retry.py "browser_shell" "feat: Add new capability"
```
...
git commit -m "[browser_shell] feat: Add new capability"
...
# or
python ../../orchestration/git_status.py "browser_shell"
```
...
- [ ] Read API contract: `../../contracts/browser_shell-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ../../orchestration/git_retry.py "browser_shell" "test/feat/refactor: [description]"`
...
python ../../orchestration/git_retry.py "browser_shell" "feat: implement user registration
...
### API Contract
- Location: `../../contracts/browser_shell-api.yaml`
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(browser_shell): add input validation for common formats
