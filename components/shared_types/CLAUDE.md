# shared_types Backend Component
...
You are a specialized agent building ONLY the shared_types backend component.
...
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "shared_types" "test: Add failing test for POST /users endpoint"
# RED: Test written, currently failing

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "shared_types" "feat: Implement basic POST /users endpoint"
# GREEN: Minimum code to pass test

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "shared_types" "test: Add validation tests for user email"
# RED: New test for email validation

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "shared_types" "feat: Add email validation to user creation"
# GREEN: Email validation implemented

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "shared_types" "refactor: Extract validation logic to validator module"
# REFACTOR: Code cleanup, tests still pass

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "shared_types" "test: Add test for duplicate user handling"
# RED: Test for 409 Conflict on duplicate

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "shared_types" "feat: Return 409 when user already exists"
...
- ✅ Work in your directory: `components/shared_types/`
...
user_facing_features:
  public_api:
    - class: DataManager
      module: components.shared_types.src.data_manager
      methods:
        - save_results
        - load_results
        - query_data
    ...
    - function: calculate_benefit
      module: components.shared_types.src.calculator
      description: Calculate therapeutic benefit scores

    - class: ValidationError
      module: components.shared_types.src.exceptions
...
**Location**: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/shared_types-api.yaml`
...
```bash
python orchestration/requirement_annotator.py auto-annotate components/shared_types
```
...
1. **Verify contract exists:**
   ```bash
   python orchestration/contract_enforcer.py check shared_types
   ```

2. **If no contract, create one:**
   ```bash
   python orchestration/contract_generator.py generate spec.md shared_types
   ```

3. **Generate implementation skeleton:**
   ```bash
   python orchestration/contract_enforcer.py skeleton shared_types
   ```
...
```python
# components/shared_types/tests/integration/test_api_endpoints.py
...
See API contract: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/shared_types_api.yaml`
...
- [ ] **Defensive Patterns**: Run `python orchestration/defensive_pattern_checker.py components/shared_types`
- [ ] **Semantic Correctness**: Run `python orchestration/semantic_verifier.py components/shared_types`
- [ ] **Contract Compliance**: Run `python orchestration/contract_enforcer.py check shared_types`
- [ ] **Requirements Traced**: Run `python orchestration/requirements_tracker.py coverage`
- [ ] **Standards Compliance**: Run `python orchestration/consistency_validator.py --component shared_types`

## Git Commit Procedures

### You work in a SHARED repository

**Location**: Your work is in `components/shared_types/`
...
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "shared_types" "feat: Add user authentication"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/shared_types/

# Commit with component prefix
git commit -m "[shared_types] feat: Add user authentication"
...
```bash
git status components/shared_types/
# or
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_status.py "shared_types"
```
...
1. **Read the API contract thoroughly**
   ```bash
   cat ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/shared_types-api.yaml
   ```
...
6. **Commit**
   ...
   python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "shared_types" "feat: Implement user creation endpoint"
   ```
...
**Check token count**:
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/context_manager.py analyze components/shared_types
```
...
- ✅ No over-mocking (no `@patch('src.')` or `@patch('components.shared_types.')`)
...
```bash
# Check test quality
python orchestration/test_quality_checker.py components/shared_types
...
1. **Over-Mocking Detection**:
   ...
   - ❌ CRITICAL: `@patch('components.shared_types.validators.EmailValidator')` - Mocking own component
...
```bash
python orchestration/completion_verifier.py components/shared_types
...
git commit -m "feat(shared_types): implement user authentication
