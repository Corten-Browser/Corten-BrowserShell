...
You are a specialized agent building ONLY the ui_chrome backend component.
...
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "ui_chrome" "test: Add failing test for POST /users endpoint"
# RED: Test written, currently failing

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "ui_chrome" "feat: Implement basic POST /users endpoint"
# GREEN: Minimum code to pass test

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "ui_chrome" "test: Add validation tests for user email"
# RED: New test for email validation

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "ui_chrome" "feat: Add email validation to user creation"
# GREEN: Email validation implemented

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "ui_chrome" "refactor: Extract validation logic to validator module"
# REFACTOR: Code cleanup, tests still pass

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "ui_chrome" "test: Add test for duplicate user handling"
# RED: Test for 409 Conflict on duplicate

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "ui_chrome" "feat: Return 409 when user already exists"
...
- ✅ Work in your directory: `components/ui_chrome/`
...
user_facing_features:
  public_api:
    - class: DataManager
      module: components.ui_chrome.src.data_manager
      methods:
        - save_results
        - load_results
        - query_data
    ...
    - function: calculate_benefit
      module: components.ui_chrome.src.calculator
      description: Calculate therapeutic benefit scores

    - class: ValidationError
      module: components.ui_chrome.src.exceptions
...
**Location**: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/ui_chrome-api.yaml`
...
```bash
python orchestration/requirement_annotator.py auto-annotate components/ui_chrome
```
...
1. **Verify contract exists:**
   ```bash
   python orchestration/contract_enforcer.py check ui_chrome
   ```

2. **If no contract, create one:**
   ```bash
   python orchestration/contract_generator.py generate spec.md ui_chrome
   ```

3. **Generate implementation skeleton:**
   ```bash
   python orchestration/contract_enforcer.py skeleton ui_chrome
   ```
...
```python
# components/ui_chrome/tests/integration/test_api_endpoints.py
...
See API contract: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/ui_chrome_api.yaml`
...
- [ ] **Defensive Patterns**: Run `python orchestration/defensive_pattern_checker.py components/ui_chrome`
- [ ] **Semantic Correctness**: Run `python orchestration/semantic_verifier.py components/ui_chrome`
- [ ] **Contract Compliance**: Run `python orchestration/contract_enforcer.py check ui_chrome`
- [ ] **Requirements Traced**: Run `python orchestration/requirements_tracker.py coverage`
- [ ] **Standards Compliance**: Run `python orchestration/consistency_validator.py --component ui_chrome`

## Git Commit Procedures

### You work in a SHARED repository

**Location**: Your work is in `components/ui_chrome/`
...
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "ui_chrome" "feat: Add user authentication"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/ui_chrome/

# Commit with component prefix
git commit -m "[ui_chrome] feat: Add user authentication"
...
```bash
git status components/ui_chrome/
# or
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_status.py "ui_chrome"
```
...
1. **Read the API contract thoroughly**
   ```bash
   cat ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/ui_chrome-api.yaml
   ```
...
6. **Commit**
   ...
   python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "ui_chrome" "feat: Implement user creation endpoint"
   ```
...
**Check token count**:
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/context_manager.py analyze components/ui_chrome
```
...
- ✅ No over-mocking (no `@patch('src.')` or `@patch('components.ui_chrome.')`)
...
```bash
# Check test quality
python orchestration/test_quality_checker.py components/ui_chrome
...
1. **Over-Mocking Detection**:
   ...
   - ❌ CRITICAL: `@patch('components.ui_chrome.validators.EmailValidator')` - Mocking own component
...
```bash
python orchestration/completion_verifier.py components/ui_chrome
...
git commit -m "feat(ui_chrome): implement user authentication
