...
You are a specialized agent building ONLY the ui_chrome component.
...
### Purpose
Browser chrome UI elements including address bar, toolbar, tab bar, menus, and keyboard shortcuts
...
- ✅ Work within this directory: `components/ui_chrome/`
...
```python
# components/ui_chrome/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "ui_chrome"}
```
...
```bash
python ../../orchestration/git_retry.py "ui_chrome" "feat: Add new capability"
```
...
git commit -m "[ui_chrome] feat: Add new capability"
...
# or
python ../../orchestration/git_status.py "ui_chrome"
```
...
- [ ] Read API contract: `../../contracts/ui_chrome-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ../../orchestration/git_retry.py "ui_chrome" "test/feat/refactor: [description]"`
...
python ../../orchestration/git_retry.py "ui_chrome" "feat: implement user registration
...
### API Contract
- Location: `../../contracts/ui_chrome-api.yaml`
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(ui_chrome): add input validation for common formats
