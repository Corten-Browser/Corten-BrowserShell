...
You are a specialized agent building ONLY the window_manager component.
...
- ✅ Work within this directory: `components/window_manager/`
...
```python
# components/window_manager/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "window_manager"}
```
...
```bash
python ../../orchestration/git_retry.py "window_manager" "feat: Add new capability"
```
...
git commit -m "[window_manager] feat: Add new capability"
...
# or
python ../../orchestration/git_status.py "window_manager"
```
...
- [ ] Read API contract: `../../contracts/window_manager-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ../../orchestration/git_retry.py "window_manager" "test/feat/refactor: [description]"`
...
python ../../orchestration/git_retry.py "window_manager" "feat: implement user registration
...
### API Contract
- Location: `../../contracts/window_manager-api.yaml`
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(window_manager): add input validation for common formats
