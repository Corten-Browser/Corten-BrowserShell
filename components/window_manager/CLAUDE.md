# window_manager Backend Component
...
You are a specialized agent building ONLY the window_manager backend component.
...
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "window_manager" "test: Add failing test for POST /users endpoint"
# RED: Test written, currently failing

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "window_manager" "feat: Implement basic POST /users endpoint"
# GREEN: Minimum code to pass test

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "window_manager" "test: Add validation tests for user email"
# RED: New test for email validation

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "window_manager" "feat: Add email validation to user creation"
# GREEN: Email validation implemented

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "window_manager" "refactor: Extract validation logic to validator module"
# REFACTOR: Code cleanup, tests still pass

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "window_manager" "test: Add test for duplicate user handling"
# RED: Test for 409 Conflict on duplicate

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "window_manager" "feat: Return 409 when user already exists"
...
- ✅ Work in your directory: `components/window_manager/`
...
user_facing_features:
  public_api:
    - class: DataManager
      module: components.window_manager.src.data_manager
      methods:
        - save_results
        - load_results
        - query_data
    ...
    - function: calculate_benefit
      module: components.window_manager.src.calculator
      description: Calculate therapeutic benefit scores

    - class: ValidationError
      module: components.window_manager.src.exceptions
...
**Location**: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/window_manager-api.yaml`
...
```bash
python orchestration/requirement_annotator.py auto-annotate components/window_manager
```
...
1. **Verify contract exists:**
   ```bash
   python orchestration/contract_enforcer.py check window_manager
   ```

2. **If no contract, create one:**
   ```bash
   python orchestration/contract_generator.py generate spec.md window_manager
   ```

3. **Generate implementation skeleton:**
   ```bash
   python orchestration/contract_enforcer.py skeleton window_manager
   ```
...
```python
# components/window_manager/tests/integration/test_api_endpoints.py
...
See API contract: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/window_manager_api.yaml`
...
- [ ] **Defensive Patterns**: Run `python orchestration/defensive_pattern_checker.py components/window_manager`
- [ ] **Semantic Correctness**: Run `python orchestration/semantic_verifier.py components/window_manager`
- [ ] **Contract Compliance**: Run `python orchestration/contract_enforcer.py check window_manager`
- [ ] **Requirements Traced**: Run `python orchestration/requirements_tracker.py coverage`
- [ ] **Standards Compliance**: Run `python orchestration/consistency_validator.py --component window_manager`

## Git Commit Procedures

### You work in a SHARED repository

**Location**: Your work is in `components/window_manager/`
...
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "window_manager" "feat: Add user authentication"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/window_manager/

# Commit with component prefix
git commit -m "[window_manager] feat: Add user authentication"
...
```
[window_manager] <type>: <description>
...
```bash
git status components/window_manager/
# or
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_status.py "window_manager"
```
...
1. **Read the API contract thoroughly**
   ```bash
   cat ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/window_manager-api.yaml
   ```
...
6. **Commit**
   ...
   python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "window_manager" "feat: Implement user creation endpoint"
   ```
...
**Check token count**:
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/context_manager.py analyze components/window_manager
```
...
- ✅ No over-mocking (no `@patch('src.')` or `@patch('components.window_manager.')`)
...
```bash
# Check test quality
python orchestration/test_quality_checker.py components/window_manager
...
1. **Over-Mocking Detection**:
   ...
   - ❌ CRITICAL: `@patch('components.window_manager.validators.EmailValidator')` - Mocking own component
...
```bash
python orchestration/completion_verifier.py components/window_manager
...
git commit -m "feat(window_manager): implement user authentication
