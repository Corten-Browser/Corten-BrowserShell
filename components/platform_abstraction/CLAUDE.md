# platform_abstraction Backend Component
...
You are a specialized agent building ONLY the platform_abstraction backend component.
...
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "platform_abstraction" "test: Add failing test for POST /users endpoint"
# RED: Test written, currently failing

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "platform_abstraction" "feat: Implement basic POST /users endpoint"
# GREEN: Minimum code to pass test

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "platform_abstraction" "test: Add validation tests for user email"
# RED: New test for email validation

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "platform_abstraction" "feat: Add email validation to user creation"
# GREEN: Email validation implemented

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "platform_abstraction" "refactor: Extract validation logic to validator module"
# REFACTOR: Code cleanup, tests still pass

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "platform_abstraction" "test: Add test for duplicate user handling"
# RED: Test for 409 Conflict on duplicate

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "platform_abstraction" "feat: Return 409 when user already exists"
...
- ✅ Read contracts from `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/`
- ✅ Read shared libraries from `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellshared-libs/`
- ✅ Work in your directory: `components/platform_abstraction/`
...
user_facing_features:
  public_api:
    - class: DataManager
      module: components.platform_abstraction.src.data_manager
      methods:
        - save_results
        - load_results
        - query_data
    ...
    - function: calculate_benefit
      module: components.platform_abstraction.src.calculator
      description: Calculate therapeutic benefit scores

    - class: ValidationError
      module: components.platform_abstraction.src.exceptions
...
**Location**: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/platform_abstraction-api.yaml`
...
```bash
python orchestration/requirement_annotator.py auto-annotate components/platform_abstraction
```
...
1. **Verify contract exists:**
   ```bash
   python orchestration/contract_enforcer.py check platform_abstraction
   ```

2. **If no contract, create one:**
   ```bash
   python orchestration/contract_generator.py generate spec.md platform_abstraction
   ```

3. **Generate implementation skeleton:**
   ```bash
   python orchestration/contract_enforcer.py skeleton platform_abstraction
   ```
...
```
components/platform_abstraction/
├── src/
...
```python
# components/platform_abstraction/tests/integration/test_api_endpoints.py
...
See API contract: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/platform_abstraction_api.yaml`
...
- [ ] **Defensive Patterns**: Run `python orchestration/defensive_pattern_checker.py components/platform_abstraction`
- [ ] **Semantic Correctness**: Run `python orchestration/semantic_verifier.py components/platform_abstraction`
- [ ] **Contract Compliance**: Run `python orchestration/contract_enforcer.py check platform_abstraction`
- [ ] **Requirements Traced**: Run `python orchestration/requirements_tracker.py coverage`
- [ ] **Standards Compliance**: Run `python orchestration/consistency_validator.py --component platform_abstraction`

## Git Commit Procedures

### You work in a SHARED repository

**Location**: Your work is in `components/platform_abstraction/`
...
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "platform_abstraction" "feat: Add user authentication"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/platform_abstraction/

# Commit with component prefix
git commit -m "[platform_abstraction] feat: Add user authentication"
...
```
[platform_abstraction] <type>: <description>
...
```bash
git status components/platform_abstraction/
# or
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_status.py "platform_abstraction"
```
...
1. **Read the API contract thoroughly**
   ```bash
   cat ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/platform_abstraction-api.yaml
   ```
...
6. **Commit**
   ...
   python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "platform_abstraction" "feat: Implement user creation endpoint"
   ```
...
**Check token count**:
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/context_manager.py analyze components/platform_abstraction
```
...
Available in `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellshared-libs/`:
...
- ✅ No over-mocking (no `@patch('src.')` or `@patch('components.platform_abstraction.')`)
...
```bash
# Check test quality
python orchestration/test_quality_checker.py components/platform_abstraction
...
1. **Over-Mocking Detection**:
   ...
   - ❌ CRITICAL: `@patch('components.platform_abstraction.validators.EmailValidator')` - Mocking own component
...
```bash
python orchestration/completion_verifier.py components/platform_abstraction
...
git commit -m "feat(platform_abstraction): implement user authentication
