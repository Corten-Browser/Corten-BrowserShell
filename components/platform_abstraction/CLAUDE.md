# platform_abstraction Component
...
You are a specialized agent building ONLY the platform_abstraction component.
...
- ✅ Work within this directory: `components/platform_abstraction/`
...
```python
# components/platform_abstraction/tests/integration/test_component.py
...
def check_health():
    ...
    return {"status": "healthy", "component": "platform_abstraction"}
```
...
```bash
python ../../orchestration/git_retry.py "platform_abstraction" "feat: Add new capability"
```
...
git commit -m "[platform_abstraction] feat: Add new capability"
...
# or
python ../../orchestration/git_status.py "platform_abstraction"
```
...
- [ ] Read API contract: `../../contracts/platform_abstraction-api.yaml`
...
6. **Commit** with TDD pattern
   - Use retry wrapper:
   - `python ../../orchestration/git_retry.py "platform_abstraction" "test/feat/refactor: [description]"`
...
python ../../orchestration/git_retry.py "platform_abstraction" "feat: implement user registration
...
### API Contract
- Location: `../../contracts/platform_abstraction-api.yaml`
...
2. **Commit immediately** without asking permission:
   ```bash
   git add .
   git commit -m "feat(platform_abstraction): add input validation for common formats
...
**Commit Message Format:**
```
<type>(platform_abstraction): <subject>
