...
You are a specialized agent building ONLY the message_bus backend component.
...
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "message_bus" "test: Add failing test for POST /users endpoint"
# RED: Test written, currently failing

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "message_bus" "feat: Implement basic POST /users endpoint"
# GREEN: Minimum code to pass test

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "message_bus" "test: Add validation tests for user email"
# RED: New test for email validation

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "message_bus" "feat: Add email validation to user creation"
# GREEN: Email validation implemented

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "message_bus" "refactor: Extract validation logic to validator module"
# REFACTOR: Code cleanup, tests still pass

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "message_bus" "test: Add test for duplicate user handling"
# RED: Test for 409 Conflict on duplicate

python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "message_bus" "feat: Return 409 when user already exists"
...
- ✅ Work in your directory: `components/message_bus/`
...
user_facing_features:
  public_api:
    - class: DataManager
      module: components.message_bus.src.data_manager
      methods:
        - save_results
        - load_results
        - query_data
    ...
    - function: calculate_benefit
      module: components.message_bus.src.calculator
      description: Calculate therapeutic benefit scores

    - class: ValidationError
      module: components.message_bus.src.exceptions
...
**Location**: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/message_bus-api.yaml`
...
```bash
python orchestration/requirement_annotator.py auto-annotate components/message_bus
```
...
1. **Verify contract exists:**
   ```bash
   python orchestration/contract_enforcer.py check message_bus
   ```

2. **If no contract, create one:**
   ```bash
   python orchestration/contract_generator.py generate spec.md message_bus
   ```

3. **Generate implementation skeleton:**
   ```bash
   python orchestration/contract_enforcer.py skeleton message_bus
   ```
...
```python
# components/message_bus/tests/integration/test_api_endpoints.py
...
See API contract: `./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/message_bus_api.yaml`
...
- [ ] **Defensive Patterns**: Run `python orchestration/defensive_pattern_checker.py components/message_bus`
- [ ] **Semantic Correctness**: Run `python orchestration/semantic_verifier.py components/message_bus`
- [ ] **Contract Compliance**: Run `python orchestration/contract_enforcer.py check message_bus`
- [ ] **Requirements Traced**: Run `python orchestration/requirements_tracker.py coverage`
- [ ] **Standards Compliance**: Run `python orchestration/consistency_validator.py --component message_bus`

## Git Commit Procedures

### You work in a SHARED repository

**Location**: Your work is in `components/message_bus/`
...
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "message_bus" "feat: Add user authentication"
```

**Option 2: Direct git with manual retry**
```bash
# Stage only your component files
git add components/message_bus/

# Commit with component prefix
git commit -m "[message_bus] feat: Add user authentication"
...
```bash
git status components/message_bus/
# or
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_status.py "message_bus"
```
...
1. **Read the API contract thoroughly**
   ```bash
   cat ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellcontracts/message_bus-api.yaml
   ```
...
6. **Commit**
   ...
   python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/git_retry.py "message_bus" "feat: Implement user creation endpoint"
   ```
...
**Check token count**:
```bash
python ./home/user/Corten-BrowserShell./home/user/Corten-BrowserShellorchestration/context_manager.py analyze components/message_bus
```
...
- ✅ No over-mocking (no `@patch('src.')` or `@patch('components.message_bus.')`)
...
```bash
# Check test quality
python orchestration/test_quality_checker.py components/message_bus
...
1. **Over-Mocking Detection**:
   ...
   - ❌ CRITICAL: `@patch('components.message_bus.validators.EmailValidator')` - Mocking own component
...
```bash
python orchestration/completion_verifier.py components/message_bus
...
git commit -m "feat(message_bus): implement user authentication
